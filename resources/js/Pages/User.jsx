...
export default function User({ user, postsByUser, following }) {
    ...
    return (
        <AuthenticatedLayout user={authUser}>
            ...
            <div className="xl:w-[100% - 280px] w-[100% - 80px] h-full pb-12 md:py-12 bg-white dark:bg-black text-gray9 dark:text-gray1">
                <TopNavUser user={user} />

                {/* User Infos */}
                <div className="mt-24 md:mt-0 lg:ml-0 md:ml-[80px] pl-4 md:pl-20 px-4">
                    <div className="flex items-center md:justify-between space-x-12">
                        <img
                            className="rounded-full object-fit w-[100px] h-auto md:w-[155px] cursor-pointer"
                            src={"../" + user.file}
                        />

                        <div className="ml-6 w-full">
                            <div className="flex items-center md:mb-6 mb-5 space-x-12 md:space-x-6">
                                <div className="md:mr-6 mr-3 rounded-lg text-[22px]">
                                    {user.username}
                                </div>
                                {following === null ? (
                                    <>
                                    ...
                                    <>
                                        ...
                                        <button onClick={ShowUnfollowOverl}>
                                            <BsThreeDots
                                    ...
                                    <div className="hidden md:block">
                                        <div className="mt-1 flex  items-center">
                                            ...
                                            <a
                                                href={user.website}
                                                target="_blank"
                                                className="font-semibold text-blue-500 break-words"
                                            >
                                                {user.website}
                                            </a>
                                        </div>
                    ...
                    <div className="flex md:hidden justify-start">
                        <div className="mt-6 font-extrabold">{user.name}</div>
                    </div>
                ...
                <div className="md:hidden">
                    <div className="w-full flex items-center justify-around border-t border-t-gray-300 mt-8">
                        ...
                        <div className="text-center p-3">
                            <div className="font-extrabold">{user.followers_count}</div>
                            <div className="text-gray-400 font-semibold -mt-1.5">
                                followers
                            </div>
                        </div>
                        <div className="text-center p-3">
                            <div className="font-extrabold">{user.following_count}</div>
                            <div className="text-gray-400 font-semibold -mt-1.5">
                                following
                            </div>
                        </div>
                    ...
                    <div className="w-full flex items-center justify-center">
                        <div className="w-full flex items-start justify-between  border-t border-t-gray-300">
                            <div className="p-3 pt-0 pl-0 w-1/3 flex justify-center items-center ">
                                <button
                                    type="button"
                                    className="hs-tab-active:font-bold hs-tab-active:border-gray9 dark:hs-tab-active:border-gray1 hs-tab-active:text-purple-500 p-[17px] w-1/4 flex justify-center items-center py-4 px-1 gap-2 border-t-[2px] border-transparent text-sm whitespace-nowrap text-black dark:text-white hover:text-purple-500 active"
                                    id="p-tab"
                                    data-hs-tab="#ps"
                                    aria-controls="ps"
                                    role="tab"
                            ...
                            <div className="p-3 pt-0 w-1/3 flex justify-center items-center ">
                                <button
                                    type="button"
                                    className="hs-tab-active:font-bold hs-tab-active:border-gray9 dark:hs-tab-active:border-gray1 hs-tab-active:text-purple-500 p-[17px] w-1/4 flex justify-center items-center py-4 px-1 gap-2 border-t-[2px] border-transparent text-sm whitespace-nowrap text-black dark:text-white hover:text-purple-500"
                                    id="rls-tab"
                                    data-hs-tab="#rls"
                                    aria-controls="rls"
                                    role="tab"
                ...
                <div className="pb-12 bg-white dark:bg-black text-gray9 dark:text-gray1 md:px-6 lg:px-6 xl:px-8">
                    <div className="md:block mt-10 hidden border-t border-t-gray-300">
                        <div className="flex items-center justify-center space-x-6 max-w-[600px] mx-auto font-extrabold text-gray-400 text-[15px]">
                            <button
                                type="button"
                                className="hs-tab-active:font-bold hs-tab-active:border-gray9 dark:hs-tab-active:border-gray1 hs-tab-active:text-purple-500 p-[17px] w-1/4 flex justify-center items-center py-4 px-1 gap-2 border-t-[3px] border-transparent text-sm whitespace-nowrap text-black dark:text-white hover:text-purple-500 active"
                                id="posts-tab"
                                data-hs-tab="#posts"
                                aria-controls="posts"
                                role="tab"
                            ...
                            <button
                                type="button"
                                className="hs-tab-active:font-bold hs-tab-active:border-gray9 dark:hs-tab-active:border-gray1 hs-tab-active:text-purple-500 p-[17px] w-1/4 flex justify-center items-center py-4 px-1 gap-2 border-t-[3px] border-transparent text-sm whitespace-nowrap text-black dark:text-white hover:text-purple-500"
                                id="reels-tab"
                                data-hs-tab="#reels"
                                aria-controls="reels"
                                role="tab"
                            ...
                            {postsByUser.data.length === 0 ? (
                                <div className="flex flex-col justify-center items-center pt-8">
                                    ...
                                    <p className="text-md mb-4">
                                        When you share photos, they will appear
                                        on your profile.
                                    </p>
