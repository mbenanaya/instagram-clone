...
export default function Index({ user, postsByUser }) {
    ...
    return (
        <AuthenticatedLayout user={user}>
            ...
            <div className="lg:w-[100% - 210px] xl:w-[100% - 220px] w-[100% - 80px] h-full pb-12 md:py-12 bg-white dark:bg-black text-gray9 dark:text-gray1">
                ...
                <div className="pb-12 bg-white dark:bg-black text-gray9 dark:text-gray1 md:pr-1.5 md:pl-[90px] lg:px-6 xl:px-8">
