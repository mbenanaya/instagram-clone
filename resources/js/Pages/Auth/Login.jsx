    ...
    return (
        <>
            ...
            <div className="h-screen flex flex-row items-start justify-evenly pt-12 mt-12 mb-0 px-2 bg-gray1 dark:bg-gray9 selection:bg-purple-500 selection:text-white md:space-x-8">
                ...
                <div className="mt-16">
                    <div className="flex flex-col justify-center h-full bg-white dark:bg-gray8 border border-gray2 dark:border-gray7 drop-shadow-lg px-12 pb-4 mt-16 md:mt-0 md:px-6 lg:px-16">
                        <div className="py-6">
