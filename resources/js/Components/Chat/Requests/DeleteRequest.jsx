...
export default function DeleteRequest({ onClose, request }) {

    const { data, setData, delete: deleteRequest, processing, errors, reset } = useForm()
    ...
    const DeleteRequest = () => {
        deleteRequest(route('deleteRequest', { id: request }))
        onClose()
    }
