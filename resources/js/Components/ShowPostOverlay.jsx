    ...
    >
      ...
      <div className="max-w-6xl h-[calc(100%-100px)] mx-auto mt-10 bg-white rounded-xl">
        <div className="w-full md:flex h-full overflow-auto rounded-xl">
          ...
          <div className="md:max-w-[500px] w-full relative bg-white dark:bg-gray9 text-black dark:text-white">
            <div className="flex items-center justify-between p-3 border-b border-b-gray5">
              ...
              {user.id === post.user.id && (
                <button onClick={() => setDeleteType('Post', setId(post.id))}>
            ...
            <div className="absolute flex border border-gray5 bottom-0 w-full max-h-[200px] bg-white dark:bg-gray9 text-black dark:text-white overflow-auto">
              <BsEmojiSmile className="ml-2 mt-[10px] text-black dark:text-white"  size={30} />
              <textarea
                ref={textareaRef}
                ...
                rows="1"
                className="w-full border-0 mt-2 mb-2 text-sm z-50 focus:ring-0 text-gray6 dark:text-white bg-white dark:bg-gray9 text-[18px]"
